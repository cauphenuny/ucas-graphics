...
namespace meshark {
template <MeshElement Element> struct MeshElementSet {
    ...
    static bool meshElementCompare(Element a, Element b) { return a.get() < b.get(); }
    ...
    MeshElementSet computeIntersection(const MeshElementSet& rhs) const {
        ...
        std::set_intersection(
            m_elements.begin(), m_elements.end(), rhs.m_elements.begin(), rhs.m_elements.end(),
