...
namespace meshark {
template <typename T> struct additional_vertex_attribute_trait {
    static constexpr bool value = false;
};
template <typename T> struct additional_edge_attribute_trait {
    static constexpr bool value = false;
};
template <typename T> struct additional_face_attribute_trait {
    static constexpr bool value = false;
};
}  // namespace meshark
